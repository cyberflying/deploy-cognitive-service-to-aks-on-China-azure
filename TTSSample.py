...
class TextToSpeech(object):
    ...
    def save_audio(self):
        base_url = 'http://<your aks load balancer ip of tts container>:<port>/'
        ...
        voice.set('name', 'zh-CN-Kangkang-Apollo') # Short name for 'Microsoft Server Speech Text to Speech Voice (en-US, Guy24KRUS)'
        voice.text = self.tts
